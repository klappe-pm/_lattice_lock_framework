...
from lattice_lock.feedback import FeedbackCollector, FeedbackCategory, FeedbackPriority, FeedbackItem
...
def test_list_feedback_filters(collector):
    ...
    user_b_bugs = [i for i in collector.list_feedback(category=FeedbackCategory.BUG) if i.source == "user_b"]
