...
mkdir -p agent_definitions/prompt_architect_agent/workflows
mkdir -p agent_definitions/prompt_architect_agent/examples

2. Create agent files:
touch agent_definitions/prompt_architect_agent/agent_prompt_architect.md
touch agent_definitions/prompt_architect_agent/capabilities.md
touch agent_definitions/prompt_architect_agent/workflows/generate_prompt.md
touch agent_definitions/prompt_architect_agent/workflows/update_prompt.md

3. Create memory file:
touch agent_memory/agents/agent_prompt_architect_memory.md
