...
- **code_generation**: o1-pro > claude-opus-4.5 > claude-sonnet-4.5 > grok-code-fast-1 > codellama:34b > magicoder:7b
- **debugging**: o1 > claude-sonnet-4 > grok-4-fast-reasoning > gemini-2.0-pro > deepseek-r1:70b > codellama:34b
- **architectural_design**: o1-pro > claude-opus-4 > gemini-3.0-pro-high > grok-4-fast-reasoning > llama3.1:70b
- **documentation**: claude-3-5-sonnet > gpt-4o > gemini-1.5-pro > grok-4-fast-non-reasoning > gemini-2.5-flash > qwen2.5:32b
- **testing**: o1-mini > claude-sonnet-4 > gemini-2.0-flash > grok-code-fast-1 > codellama:34b
- **data_analysis**: o1-pro > gemini-3.0-pro-low > gpt-4o > grok-4-fast-reasoning > llama3.1:70b > qwen2.5:32b
- **general**: gpt-4o > claude-3-5-haiku > gemini-2.5-flash > grok-4-fast-non-reasoning > llama3.1:8b
- **reasoning**: o1-pro > claude-opus-4.5 > grok-4-fast-reasoning > gemini-3.0-pro-high > deepseek-r1:70b > llama3.1:405b
...
| Ollama | codellama:34b, deepseek-r1:70b, qwen2.5:32b, magicoder:7b, llama3.1:70b, llama3.1:405b, etc. | Local/Free, requires Ollama installation |
