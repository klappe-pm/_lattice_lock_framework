...
class FrontmatterParser:
    ...
    # Looks for a starting '---', followed by content (frontmatter),
    # followed by another '---'.
    # This might need refinement if '---' is used inside strings, but standard frontmatter
    # is usually strict about line starts.
    ...
    def parse(self, file_path: str) -> tuple[dict[str, Any], dict[str, Any]]:
        ...
        Returns:
            ...
            If no frontmatter is present, returns ({}, content_dict).
        """
