...
class User(Base, UUIDMixin, TimestampMixin):
    ...
    # OAuth/SSO
    auth_provider: Mapped[str | None] = mapped_column(String(50))  # 'local', 'google', 'github'
    external_id: Mapped[str | None] = mapped_column(String(255))  # Provider's user ID
...
class Permission(Base, UUIDMixin, TimestampMixin):
    ...
    category: Mapped[str | None] = mapped_column(String(50))  # 'models', 'admin', 'billing', 'api'
