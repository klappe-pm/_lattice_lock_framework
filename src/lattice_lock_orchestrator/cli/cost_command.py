...
def handle_cost(console: Console, detailed: bool = False):
    ...
    try:
        ...
        console.print(f"[bold blue]Total Cost (30d):[/bold blue] [green]${report['total_cost']:.6f}[/green]\n")
        ...
        if detailed:
            ...
            sorted_models = sorted(report.get("by_model", {}).items(), key=lambda x: x[1], reverse=True)
