...
if TYPE_CHECKING:
    from lattice_lock.agents.prompt_architect.subagents.prompt_generator import PromptGenerator
...
class PromptArchitectAgent:
    ...
    def prompt_generator(self) -> "PromptGenerator":
        ...
        if self._prompt_generator is None:
            config_path = str(
                self.repo_root
                / "docs/agents/agent_definitions/prompt_architect_agent/subagents/prompt_architect_agent_prompt_generator_definition.yaml"
            )
