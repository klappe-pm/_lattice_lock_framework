...
@click.pass_context
def compile_config(
    ctx: click.Context, config_path: Path, output: Path | None, base_path: Path | None, pretty: bool
):
...
@click.pass_context
def inspect_config(
    ctx: click.Context, config_path: Path, show_inheritance: bool, base_path: Path | None
):
