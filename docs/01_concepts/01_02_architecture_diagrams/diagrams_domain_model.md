...
file_ids: [domain-model-001]
aliases: [entity-relationship-diagram]
tags: [mermaid, database, erd]
diagram_type: erd
author: Architect Agent
---

> [!NOTE]
> This domain model represents the target architecture. Partial implementation exists in `src/database/models/`.
