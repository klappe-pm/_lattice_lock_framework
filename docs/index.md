...
- [Configuration](docs/getting_started/configuration.md) - Configure your project
...
- [CLI Overview](docs/reference/cli/index.md) - Command-line interface overview
- [validate](validate.md) - Validate project structure
- [sheriff](docs/reference/cli/sheriff.md) - Run static analysis
- [gauntlet](docs/reference/cli/gauntlet.md) - Generate contract tests
- [doctor](doctor.md) - Diagnose issues
- [init](init.md) - Initialize a new project
- [orchestrator](docs/reference/cli/orchestrator.md) - Model orchestrator commands
...
- [Model Registry](docs/models/README.md) - Model configuration and selection guide
