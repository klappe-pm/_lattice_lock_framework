...
**Primary Report**: `docs/agent_outputs/[Category]/[analysis-name]-report.md`
**Supporting Data**: `docs/agent_outputs/Architecture/[analysis-name]-data.json`
**Diagrams**: `docs/agent_outputs/Diagrams/[analysis-name]-diagram.md`
